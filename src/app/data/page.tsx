...
export default async function DataPage({ searchParams }: { searchParams: Promise<{ restored?: string }> }) {
  ...
  return <div className="page"><PageHeader title="Imports & exports" description="Portable backups, validated restores, value-set imports, and normalized datasets for independent analysis." />
    ...
    <div className="grid two-col"><div className="stack"><Panel title="Complete JSON backup"><p>Includes value sets, definitions, contexts, sessions, comparisons, rankings, claims, tensions, settings, and evidence links.</p><a className="btn btn-primary" href="/api/export/json"><FileJson size={16} /> Download complete backup</a></Panel>
