...
const navigation = [
  ...
  ["/history", "History", History], ["/reports", "Reports", FileText], ["/data", "Imports & exports", Database], ["/settings", "Settings", Settings],
] as const;
...
export function AppShell({ children }: { children: React.ReactNode }) {
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <div className="sidebar-footer"><span className="small muted">Local database</span><ThemeToggle /></div>
    </aside>
